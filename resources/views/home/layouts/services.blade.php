            ...
            <div class="row">
                @foreach($posts as $post)
                    <div class="col-md-4">
                        ...
                        <p class="services_text text-muted text-justify mt-2 p-2">{{$post->content}}</p>
                        <span class="text-secondary d-block mt-3 p-2">
                            Added by <a href="http://localhost:8000/user/1" class="text-primary">Admin</a> on {{$post->created_at->diffForHumans()}}
                        </span>
