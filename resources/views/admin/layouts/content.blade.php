<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-4">
            ...
            <div class="avatar"><img src="assests/img/avatar-1.jpg" alt="..." class="img-fluid">
        ...
        <div class="col-lg-4">
            <div class="user-block block text-center">
            <div class="avatar"><img src="assests/img/avatar-4.jpg" alt="..." class="img-fluid">
        ...
        <div class="col-lg-4">
            <div class="user-block block text-center">
            <div class="avatar"><img src="assests/img/avatar-6.jpg" alt="..." class="img-fluid">
        ...
        <div class="row d-flex align-items-center">                   
            ...
            <div class="avatar"> <img src="assests/img/avatar-1.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Tomas Hecktor</strong><span class="d-block">@tomhecktor</span></a>
            </div>
        ...
        <div class="row d-flex align-items-center">                   
            ...
            <div class="avatar"> <img src="assests/img/avatar-2.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Alexander Shelby</strong><span class="d-block">@alexshelby</span></a>
            </div>
            <div class="col-lg-4 text-center">
        ...
        <div class="row d-flex align-items-center">                   
            ...
            <div class="avatar"> <img src="assests/img/avatar-6.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Arther Kooper</strong><span class="d-block">@artherkooper</span></a>
            </div>
            <div class="col-lg-4 text-center">
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-6">                                           
                ...
                <div class="messages"><a href="#" class="message d-flex align-items-center">
                    <div class="profile"><img src="assests/img/avatar-3.jpg" alt="..." class="img-fluid">
                    ...
                    <div class="profile"><img src="assests/img/avatar-2.jpg" alt="..." class="img-fluid">
                    ...
                    <div class="profile"><img src="assests/img/avatar-1.jpg" alt="..." class="img-fluid">
                    ...
                    <div class="profile"><img src="assests/img/avatar-5.jpg" alt="..." class="img-fluid">
