                            ...
                            <div class="col-lg-12">
                                <div class="block margin-bottom-sm">
                                                                ...
                                                                <div role="document" class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <form id="delete-form-{{$request['id']}}" action="" method="REQUEST" class="d-none">
                                                                                @method('delete')
                                                                                @csrf
                                                                            </form>
                                                                        </div>
                                    ...
                                    @elseif($do == 'edit')
                                        <div class="block">
                                            <div class="title">
                                                <strong class="d-block">Edit Request</strong>
                                            </div>
                                            <div class="block-body">
                                                <form action="{{route('request.update', $request->id)}}" method="REQUEST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PATCH')
                                                    <div class="form-group">
                                                        <label class="form-control-label">Title</label>
                                                        <input type="text" name="title" placeholder="Request Title" class="form-control" required value="{{$request->title}}">
                                                        @error('title')
                                                    ...
                                                    <div class="form-group">       
                                                        ...
                                                        <textarea name="content" placeholder="Request Content" class="form-control" required>{{$request->content}}</textarea>
                                                        @error('content')
                                                            <p class="text-danger mt-1 mb-0">{{$message}}</p>
                                                        @enderror
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="image" placeholder="Request Image" class="form-control" value="{{$request->image}}">
                                                        @error('image')
                                                            <p class="text-danger mt-1 mb-0">{{$message}}</p>
                                                        @enderror
                                                    </div>
